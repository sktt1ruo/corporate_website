...
class Product(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("online_shop_products:product_detail", kwargs={"pk": self.pk})
...
class Variation(models.Model):
    ...
    def get_html_price(self):
        if self.sale_price is not None:
            ...
            html_text = "<span class='price'>%s</spam>" % (self.price)
...
class Category(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("online_shop_categories:category_detail", kwargs={"slug": self.slug})
